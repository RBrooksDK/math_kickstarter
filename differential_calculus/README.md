...
For step-by-step worked examples and formulas for this topic, see the [Differential Calculus tutorial](/math_kickstarter/pages/tutorials/differential_calculus/).
